...
namespace TestFramework {
	...
	public:
		Renderer(GraphicsContext* InContext, const RendererInfo& InInfo);
		~Renderer() = default;
		...
		CommandPool* GetCurrentCommandAllocator() const { return m_CommandAllocators[m_CurrentFrame].get(); }
	...
	private:
		...
		std::vector<std::unique_ptr<CommandPool>> m_CommandAllocators;
